...
define( 'DB_NAME', 'achieve_fas-medical-summit-v2' );

/** Database username */
define( 'DB_USER', 'achieve_fas-medical-summit-v2' );

/** Database password */
define( 'DB_PASSWORD', '7gBDzWrPvlKI' );
 ...
 * @since 2.6.0
 */
define( 'AUTH_KEY',         '9iPw=!uvk-F7tZ4.ugh-ut}J#KxQkwOE#GRx-@~mRe multiple installations izv2' );
 ...
 *
 * You can hav2Fdebug/debug-wordpress/
%n one database if you give each
 ...
 */
 define( 'WP_HOME', 'https://achieveee.com/fas-medical-summit-v2/' );
define( 'WP_SITEURL', 'https://achieveee.com/fas-medical-summit-v2/' );
