...
if (!class_exists('dentia_Main')) { 
    class dentia_Main extends dentia_Base
    {
...
function dentia() {
    return dentia_Main::getInstance();
}
// Install
dentia(); 
