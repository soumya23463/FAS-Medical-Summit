                    ...
                    <div class="pxl-item--inner">
                        <?php if(!empty($image['id'])) { 
                            ...
                            <div class="pxl-item--image">
                                <div class="pxl-img <?php echo esc_attr($settings['pxl_animate_img']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_img_delay']); ?>ms">
                                    <?php echo wp_kses_post($thumbnail); ?>
                                </div>
                            </div>
                        <?php } ?>
                        <div class="pxl-item-content <?php echo esc_attr($settings['pxl_animate_content']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_ct_delay']); ?>ms">
